...
declare global {
  interface Window {
    ...
    SpeechRecognitionEvent: typeof SpeechRecognition
  }
}
  ...
  return (
    <div>
      <form onSubmit={handleSubmit(onSubmit)} className="w-screen min-h-screen relative">
        ...
        <div className={`w-screen h-screen absolute top-0 left-0 z-40 ${isSubmitting ? "block" : "hidden"}`}>
          <ThinkingBrain3DModel />
        </div>

        {/* Age input - top left */}
        <div className="absolute top-[40px] left-5 z-20 max-lg:left-1/2 max-lg:transform max-lg:-translate-x-1/2 max-lg:w-[90%] max-lg:max-w-[400px]">
          <input
            type="number"
            {...register("age")}
            placeholder="Enter Your Age"
            className={`${bebasNeue.className} w-[400px] max-lg:w-full text-center placeholder:text-center h-[60px] border-white border-[1px] rounded-md shadow-lg shadow-[#e5e5e5] text-white bg-transparent px-4 text-xl`}
          />
          {errors.age && <p className="text-orange-500 text-sm">{errors.age.message}</p>}
        </div>

        {/* Salary input - top right */}
        <div className="absolute top-[40px] right-8 z-20 max-lg:left-1/2 max-lg:transform max-lg:-translate-x-1/2 max-lg:w-[90%] max-lg:max-w-[400px] max-lg:top-[120px]">
          <input
            type="number"
            {...register("salary")}
        ...
        <div className="absolute bottom-[260px] right-8 z-20 max-lg:left-1/2 max-lg:transform max-lg:-translate-x-1/2 max-lg:w-[90%] max-lg:max-w-[400px] max-lg:bottom-[120px]">
          <input
            type="text"
            {...register("location")}
        ...
        {/* Occupation input - bottom left */}
        <div className="absolute bottom-[260px] left-5 z-20 max-lg:left-1/2 max-lg:transform max-lg:-translate-x-1/2 max-lg:w-[90%] max-lg:max-w-[400px] max-lg:bottom-[200px]">
          <input
            {...register("occupation")}
            type="text"
        ...
        {/* Description input - center bottom */}
        <div className="absolute bottom-[300px] left-[50%] translate-x-[-50%] z-20 w-[90%] max-w-[400px] max-lg:bottom-[280px]">
          <input
            type="text"
            {...register("description")}
            placeholder="Description for Scheme"
            className={`${bebasNeue.className} w-full text-center placeholder:text-center h-[60px] border-white border-[1px] rounded-md shadow-lg shadow-[#e5e5e5] text-white bg-transparent px-4 text-xl`}
          />
        ...
        <div
          ...
          className={`${bebasNeue.className} w-[200px] h-[50px] bg-black text-white shadow-md shadow-[#e5e5e5] flex items-center justify-center absolute inset-0 m-auto z-20 top-64 max-lg:top-[unset] max-lg:bottom-[360px] rounded-lg border-[1px] border-black cursor-pointer`}
        >
        ...
        <button
          type="submit"
          className={`${bebasNeue.className} w-[200px] h-[50px] bg-black text-white shadow-md shadow-[#e5e5e5] flex items-center justify-center absolute inset-0 m-auto z-20 top-96 max-lg:top-[unset] max-lg:bottom-[40px] rounded-lg border-[1px] border-black`}
        >
