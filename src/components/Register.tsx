        ...
        <div className="bg-[#0A0A0A] rounded-xl border border-[#222222] shadow-xl p-8">
          ...
          <div className="w-full space-y-3">
            <button className="w-full h-12 bg-[#111111] text-[#E5E5E5] border border-[#333333] flex gap-3 items-center justify-center rounded-md hover:bg-[#222222] transition-all duration-300">
              ...
              <span className={bebasNeue.className}>REGISTER WITH GOOGLE</span>
            </button>

            <button className="w-full h-12 bg-[#111111] text-[#E5E5E5] border border-[#333333] flex gap-3 items-center justify-center rounded-md hover:bg-[#222222] transition-all duration-300">
              <FaFacebook className="text-[#E5E5E5]" />
              <span className={bebasNeue.className}>REGISTER WITH FACEBOOK</span>
            </button>

            <button className="w-full h-12 bg-[#111111] text-[#E5E5E5] border border-[#333333] flex gap-3 items-center justify-center rounded-md hover:bg-[#222222] transition-all duration-300">
              <FaGithub className="text-[#E5E5E5]" />
              <span className={bebasNeue.className}>REGISTER WITH GITHUB</span>
            </button>
          </div>
        </div>
      </div>
